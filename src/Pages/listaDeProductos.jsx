...
function ListarProductos() {
  ...
  // Declaro la variable del reconocimiento de voz
  ...
  // Detectamos si esta usando el movil
  const isMobile = /Mobi|Android/i.test(navigator.userAgent);

  const [touchStartX, setTouchStartX] = useState(null);

  // Variable para declarar el inicio donde empieza a deslizar
  const handleTouchStart = (e) => {
    setTouchStartX(e.touches[0].clientX);
  };

  // Variable para declarar el fin donde empieza a deslizar
  ...
  return (
    <>
      ...
      <Layout>
        ...
        <div
        // Llamo a las variable de las posiciones del deslizar
        ...
        >
          ...
          // Si es movil y permite el reconocimiento de voz, lo activa
